...
public class PermissionsActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_PERMISSIONS = "com.bigwhite.crab.EXTRA_PERMISSIONS";
    ...
    private void showMissingPermissionDialog() {
        ...
        dialogBuilder.setTitle("帮助");
        dialogBuilder.setMessage("前往系统设置?");
        ...
        dialogBuilder.setPositiveButton("进入", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startAppSettings();
            }
