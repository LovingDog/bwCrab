...
public class MerchantList {
    private List<Goods> content = new ArrayList<>();
    ...
    public MerchantList(List<Goods> content, int totalElements, int totalPages, boolean last, int number, int size, String sort, int numberOfElements, boolean first) {
