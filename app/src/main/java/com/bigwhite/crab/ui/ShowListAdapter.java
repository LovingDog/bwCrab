...
import com.bigwhite.crab.ui.ListItemFragment.OnListFragmentInteractionListener;
...
public class ShowListAdapter extends RecyclerView.Adapter<ShowListAdapter.ViewHolder> {
    ...
    public ShowListAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
